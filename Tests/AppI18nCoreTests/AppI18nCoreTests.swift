...
final class AppI18nCoreTests: XCTestCase {
    ...
    func testPreviewHTMLGeneratesIndexAndAppPages() throws {
        try withTempDir { dir in
            ...
            XCTAssertTrue(indexHTML.contains("<link rel=\"icon\" type=\"image/png\" href=\"assets/logos/menuist.png\">"))
            ...
            XCTAssertTrue(appHTML.contains("<link rel=\"icon\" type=\"image/png\" href=\"assets/logos/menuist.png\">"))
